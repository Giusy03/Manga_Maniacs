...
public class mangaBean {
	...
	private String dataProdotto=null;
	...
	public String toString() {
		return "mangaBean [id=" + id + ", Titolo=" + Titolo + ", prezzo=" + prezzo + ", editore=" + editore
				...
				+ ", img=" + img + ", lingua=" + lingua + ", inv=" + inv + ", generi=" + generi + "]";
	}
	public int getId() {
		return id;
	}
	...
	public String getDataProdotto() {
		return dataProdotto;
	}
	public void setDataProdotto(String dataProdotto) {
